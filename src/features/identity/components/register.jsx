...
const Register = () => {
  ...
  const submitForm = useSubmit(); // be in tarigh, submit form az tarighe react-router-dom anjam mishavad
  // be tore automatic registerAction call mishavad va data dar database sabt mishavad
    ...
    <>
      <div className="text-center mt-4">
        ...
        <p className="lead">
          ...
          <Link to="/login" className="me-2 ms-2">
            {t("register.signin")}
          </Link>
        </p>
      </div>
